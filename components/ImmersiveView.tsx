      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
        {isBreathing && (
          <div className="relative">
            <div className="w-72 h-72 rounded-full bg-sky-200/10 blur-3xl breathing-circle absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
            <div className="w-56 h-56 rounded-full border border-white/20 breathing-circle flex items-center justify-center text-white/90 font-light tracking-[0.3em] text-sm backdrop-blur-sm bg-white/5">
              BREATHE
            </div>
          </div>
        )}
        ...
        <div className="max-w-md mx-auto w-full">
           <div className="flex justify-between items-end mb-4">
             <div>
               ...
               <p className="text-zinc-400 text-xs">Design your own safe environment.</p>
             </div>
